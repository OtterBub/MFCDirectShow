...
class CSKParkFilter : public CBaseFilter
{
	CSKPark * const m_pDump;

public:

	// Constructor
	CSKParkFilter(CSKPark *pDump,
		LPUNKNOWN pUnk,
		CCritSec *pLock,
		HRESULT *phr);
...
class CSKParkInputPin : public CRenderedInputPin
{
	CSKPark    * const m_pDump;           // Main renderer object
	CCritSec * const m_pReceiveLock;    // Sample critical section
	REFERENCE_TIME m_tLast;             // Last sample receive time

public:

	CSKParkInputPin(CSKPark *pDump,
		LPUNKNOWN pUnk,
		CBaseFilter *pFilter,
		CCritSec *pLock,
...
class CSKPark : public CUnknown, public IFileSinkFilter
{
	friend class CSKParkFilter;
	friend class CSKParkInputPin;

	CSKParkFilter   *m_pFilter;       // Methods for filter interfaces
	CSKParkInputPin *m_pPin;          // A simple rendered input pin
...
public:
	...
	CSKPark(LPUNKNOWN pUnk, HRESULT *phr);
	~CSKPark();
